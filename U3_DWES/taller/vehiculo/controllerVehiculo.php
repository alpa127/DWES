...
<body>
    <header>
        ...
        ?>
        <h3 style="text-align: center;">GESTIÓN DE VEHICULOS</h3>
    </header>
    <section>
        <!-- Crear Vehiculos -->
    ...
    <section>
        <!-- Seleccionar / Visualizar datos de vehículo -->
