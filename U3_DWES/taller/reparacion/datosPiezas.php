        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                foreach($piezas as $pr){
                    ...
                    echo '<td>';
                    echo '<button class="btn btn-outline-dark" name="modif" value="'.$pr->getP()->getCodigo().'"><img src="../icon/modif25.png"/></button>';
                    echo '<button class="btn btn-outline-dark"  data-bs-toggle="modal" data-bs-tager="#a'.$pr->getP()->getCodigo().'" name="avisar" value="'.$pr->getP()->getCodigo().'"><img src="../icon/delete25.png"/></button>';
                    echo '</td>';
                    }
                    echo '</tr>';
                  ...
                  <!-- Modal footer -->
                    ...
                    <button type="button" name="borrar"
